...
class Pix2Pix:
    ...
    def build_discriminator(self, input_shape):
        def d_layer(input, filters, batch_norm, f_size=4):
        ...
        d1 = d_layer(input=combined_imgs, filters=n, batch_norm=False)
        d2 = d_layer(input=d1, filters=n * 2, batch_norm=True)
        d3 = d_layer(input=d2, filters=n * 4, batch_norm=True)
        d4 = d_layer(input=d3, filters=n * 8, batch_norm=True)
